<template>
    <div class="text-center">
        ...
        <br />
        <span class="text-success pb-3 h3" v-if="gameStore.getScore>gameStore.getWinningScore">You Won!</span>
        <span class="text-dange pb-3 h3" v-else-if="gameStore.getScore<0">You lost! :(</span>
        <div class="row" v-if="gameStore.getScore<gameStore.getWinningScore && gameStore.getScore>0">
            <div class="col-5 offset-1">
                <button 
                    class="form-control btn btn-success p-4" 
                    @click="Increment"
                >
                    Increment
                </button>
            ...
            <div class="col-5">
                <button 
                    class="form-control btn btn-danger p-4" 
                    @click="Decrement"
                >
                    Decrement
                </button>
